...
class Element(Gtk.Bin):
    ...
    def __init__(self, child_dict=None, use_action_button=True, pack_type=0, **kwargs):
        ...
        **kwargs
        ...
        if not kwargs.get("name", False):
            self.set_name("quanta-element")

        self.type = "element"
        self.action_button = Gtk.Button(name="quanta-element-action_button")
        self.main_grid = Gtk.Grid(name="quanta-element-main_grid")
        self.header_grid = Gtk.Grid(name="quanta-element-header_grid")
    ...
    def __remove_child__(self):
        ...
        if not child:
            err = "Quanta Element has no child"
