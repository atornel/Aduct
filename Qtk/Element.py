    ...
    def __init__(self, child_dict=None, use_action_button=True, pack_type=0, **kwargs):
        ...
        **kwargs
        ...
        if not kwargs.get("name", False):
            self.set_name("qtk-element")

        self.type = "element"
        self.action_button = Gtk.Button(name="qtk-element-action_button")
        self.main_grid = Gtk.Grid(name="qtk-element-main_grid")
        self.header_grid = Gtk.Grid(name="qtk-element-header_grid")
