...
from Qtk.Element import Element
from Qtk.Provider import Provider
from Qtk.Views import Bin, Paned, Notebook, View
...
def add_to_view(child, view):
    ...
    Arguments
    ---------
    child : :class:`Gtk.Widget` or Qtk.Element.Element
...
def replace_child(view, child1, child2):
    ...
    try:
        ...
        raise TypeError(f"Expected a Qtk.View but got {view}")
