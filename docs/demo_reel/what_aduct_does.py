...
class ButtonProvider(Aduct.Provider):
    ...
    name = GObject.Property(type=str, default="ButtonProvider", flags=GObject.ParamFlags.READABLE)
...
class TextProvider(Aduct.Provider):
    ...
    name = GObject.Property(type=str, default="TextProvider", flags=GObject.ParamFlags.READABLE)
...
class ImagesProvider(Aduct.Provider):
    ...
    name = GObject.Property(type=str, default="ImagesProvider", flags=GObject.ParamFlags.READABLE)
...
class ViewerProvider(Aduct.Provider):
    ...
    name = GObject.Property(type=str, default="ViewerProvider", flags=GObject.ParamFlags.READABLE)
